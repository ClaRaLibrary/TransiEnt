...
//___________________________________________________________________________//
  ...
  SI.Efficiency eta(start=1) "Efficiency of the electrolyzer";
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}})), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Line(
          points={{-80,-40}},
          color={255,0,0},
