...
//___________________________________________________________________________//
  ...
  TransiEnt.Producer.Gas.Electrolyzer.Controller.FeedInStorageController feedInStorageController(
    ...
    redeclare model Charline = Charline) annotation (Placement(transformation(
        ...
        origin={-60,26})));
protected
  TransiEnt.Producer.Gas.Electrolyzer.Controller.FeedInStorageTWVController feedInStorageTWVController annotation (Placement(transformation(extent={{-10,-46},{10,-26}})));
