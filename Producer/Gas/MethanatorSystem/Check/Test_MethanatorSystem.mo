...
//________________________________________________________________________________//
  ...
  MethanatorSystem methanatorSystem(m_flow_n_Hydrogen=0.0339027, integrateMassFlow=false)
  ...
  TransiEnt.Components.Boundaries.Gas.BoundaryRealGas_pTxi boundaryRealGas_pTxi2(
    variable_p=true, p_const=1700000)                                                                      annotation (Placement(transformation(extent={{52,-42},{32,-22}})));
