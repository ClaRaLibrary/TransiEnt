...
model PitchController_SI_delfaF "Pitch Controller for WTG with delta_f synthetic inertia control"
...
Modelica.Blocks.Logical.Switch switchToHalt1
  ...
  Modelica.Blocks.Interfaces.RealInput freq_deviation annotation (Placement(
        transformation(
        rotation=90,
        extent={{-10,-10},{10,10}},
        origin={-60,-124})));
