...
//________________________________________________________________________________//
  ...
  ClaRa.Components.BoundaryConditions.BoundaryVLE_Txim_flow source1(
    ...
    T_const=60 + 273) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={18,0})));
  SimpleBoiler gasBoiler1(useGasPort=false)
  ...
  ClaRa.Components.BoundaryConditions.BoundaryVLE_Txim_flow source2(
    ...
    T_const=60 + 273) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={76,-66})));
  TwoFuelBoiler twoFuelBoiler             annotation (Placement(transformation(extent={{100,-76},{120,-56}})));
equation
  ...
  connect(twoFuelBoiler.outlet, sink2.steam_a) annotation (Line(
      points={{120,-66},{134,-66},{134,-65}},
      color={175,0,0},
      thickness=0.5));
  connect(twoFuelBoiler.inlet, source2.steam_a) annotation (Line(
      points={{100.2,-66},{86,-66}},
      color={175,0,0},
      thickness=0.5));
  connect(ramp.y, twoFuelBoiler.Q_flow_set_B1) annotation (Line(points={{-71,44},{104.2,44},{104.2,-56.2}}, color={0,0,127}));
  connect(ramp.y, twoFuelBoiler.Q_flow_set_B2) annotation (Line(points={{-71,44},{116,44},{116,-56.2}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{160,100}})), Documentation(info="<html>
