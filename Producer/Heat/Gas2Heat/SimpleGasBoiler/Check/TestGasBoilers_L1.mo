...
//________________________________________________________________________________//
  ...
  inner SimCenter simCenter(integrateHeatFlow=true)
  ...
  ClaRa.Components.BoundaryConditions.BoundaryVLE_Txim_flow source(
    ...
    T_const=60 + 273) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-74,-1})));
  SimpleGasBoiler.GasBoilerCompositionAdaptive gasBoilerGasAdaptive annotation (Placement(transformation(extent={{-46,-24},{-4,20}})));
  ...
  SimpleBoiler gasBoiler(Add_GasPort=true, integrateHeatFlow=false)
                                           annotation (Placement(transformation(extent={{-12,28},{30,72}})));
...
<p>Test environment for gas boilers</p>
