...
//________________________________________________________________________________//
  ...
  Modelica.Blocks.Interfaces.RealInput Q_flow_set_B1 "Setpoint for thermal heat of boiler 1"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        ...
        rotation=270,
        origin={-58,98})));
  Modelica.Blocks.Interfaces.RealInput Q_flow_set_B2 "Setpoint for thermal heat of boiler 2"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=270,
        origin={53,102}),
        iconTransformation(extent={{-10,-10},{10,10}},
  ...
  replaceable TransiEnt.Producer.Heat.Gas2Heat.Base.PartialBoiler boiler1 constrainedby TransiEnt.Producer.Heat.Gas2Heat.Base.PartialBoiler annotation (choicesAllMatching=true, Placement(transformation(extent={{-61,-23},{-10,23}})));
  replaceable TransiEnt.Producer.Heat.Gas2Heat.Base.PartialBoiler boiler2 constrainedby TransiEnt.Producer.Heat.Gas2Heat.Base.PartialBoiler annotation (choicesAllMatching=true, Placement(transformation(extent={{27,-23},{78,23}})));
