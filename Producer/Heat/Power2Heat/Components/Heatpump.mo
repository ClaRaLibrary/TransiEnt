...
//________________________________________________________________________________//
  ...
  parameter SI.Temperature T_bivalent "Bivalent temperature where heatpump starts operating (if Tamb > T_bivalent)";
  parameter SI.Temperature T_heatingLimit "Temperature limit above which heatpump is turned off (off ist Tamb>T_heatingLimit)";
  parameter TransiEnt.Basics.Types.OnOffRelaisStatus init_state=TransiEnt.Basics.Types.on_ready "State of relais at initialization";
...
equation
  ...
  connect(dynamic.y, heatFlowBoundary.Q_flow) annotation (Line(points={{75,-52},{84,-52},{84,-32},{84,-20},{68,-20},{68,0},{72,0}}, color={0,0,127}));
...
<p>Model of a controlled heat pump with heatport.</p>
