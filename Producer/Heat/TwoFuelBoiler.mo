...
//___________________________________________________________________________//
  ...
  replaceable TransiEnt.Producer.Heat.Base.PartialBoiler boiler1 constrainedby TransiEnt.Producer.Heat.Base.PartialBoiler annotation (choicesAllMatching=true, Placement(transformation(extent={{-61,-23},{-10,23}})));
  replaceable TransiEnt.Producer.Heat.Base.PartialBoiler boiler2 constrainedby TransiEnt.Producer.Heat.Base.PartialBoiler annotation (choicesAllMatching=true, Placement(transformation(extent={{27,-23},{78,23}})));
