...
<p>Model modified by Oliver Sch&uuml;lting (oliver.schuelting@tuhh.de), Jun 2018: no anisotropy if irradiance_extraterrestrial&lt;=25 since this lead to unrealistic high irradiation peaks at morning and/or evening</p>
</html>"));
end Skymodel_HDKR;
