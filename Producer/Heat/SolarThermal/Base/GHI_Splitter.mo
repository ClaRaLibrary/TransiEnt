...
equation
  ...
  if DiffuseModel=="Skartveit and Olseth" then
    ...
    k0=0.24;
    kc=0.82-0.51*exp(-0.06*(90-SI.Conversions.to_deg(irradiance.skymodel.angle_tilted)));
    dc=0.12+0.46*exp(-0.06*(90-SI.Conversions.to_deg(irradiance.skymodel.angle_tilted)));
