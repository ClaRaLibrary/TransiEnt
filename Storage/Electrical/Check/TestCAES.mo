...
//___________________________________________________________________________//
  ...
  CAES Storage(redeclare TransiEnt.Components.Statistics.ConfigurationData.StorageCostSpecs.PumpStorage CostModel, StorageModelParams=TransiEnt.Storage.Electrical.Specifications.PumpedStorage(
        E_max=1e14,
        P_max_unload=900e6,
        P_max_load=90e6,
        eta_unload=1,
