...
//___________________________________________________________________________//
  ...
  PrimaryControlStorage primaryControlStorage(Storage(StorageModelParams=TransiEnt.Storage.Electrical.Specifications.LeadAcidBattery(), redeclare TransiEnt.Components.Statistics.ConfigurationData.StorageCostSpecs.ElectricStorageGeneral CostModel)) annotation (Placement(transformation(extent={{-20,-8},{0,12}})));
equation
