...
//___________________________________________________________________________//
  extends TransiEnt.Storage.Base.GenericStorageParameters(
     E_start=E_min, E_max=P_max_unload*24*3600, E_min=0.3*E_max, P_max_unload=420, P_grad_max=P_max_unload/0.1, eta_unload=0.9, eta_load=0.9,selfDischargeRate=0.01/100*E_max/3600);
