...
//___________________________________________________________________________//
  extends TransiEnt.Storage.Base.GenericStorageParameters(
     E_start=E_min, E_max=P_max_unload*100, E_min=0, P_max_unload=50e6, P_grad_max=P_max_unload/4e-3, eta_unload=0.975, eta_load=0.975,selfDischargeRate=0.1*E_max/3600);
