...
// _____________________________________________
  ...
  Modelica.Blocks.Interfaces.RealOutput Q_gen "Temperature in heat reservoir in K"
                                         annotation (
...
// _____________________________________________
  ...
  Modelica.Blocks.Interfaces.RealOutput T_Stor "Temperature in heat reservoir in K"
                                         annotation (
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC",
