...
//  parameter Real CoalCost;
  ...
  Modelica.Blocks.Interfaces.RealInput Q_flow_Target_WT
    annotation (Placement(transformation(extent={{-142,-2},{-102,38}}), iconTransformation(extent={{-120,40},{-100,60}})));
  Modelica.Blocks.Interfaces.RealInput Q_flow_Target_WW
    annotation (Placement(transformation(extent={{-140,-80},{-100,-40}}),
        iconTransformation(extent={{-120,-60},{-100,-40}})));
  Modelica.Blocks.Interfaces.RealOutput P_out_WT annotation (Placement(
        transformation(extent={{100,76},{120,96}}), iconTransformation(extent={{100,60},{120,80}})));
  Modelica.Blocks.Interfaces.RealOutput P_out_WW1 annotation (Placement(
        transformation(extent={{100,38},{120,58}}), iconTransformation(extent={{100,20},{120,40}})));
  Modelica.Blocks.Interfaces.RealOutput P_out_WW2 annotation (Placement(
        transformation(extent={{100,-20},{120,0}}),   iconTransformation(extent={{100,-20},{120,0}})));
  Modelica.Blocks.Interfaces.RealOutput P_out_total annotation (Placement(
        transformation(extent={{100,-86},{120,-66}}), iconTransformation(extent={{100,-86},{120,-66}})));
  Modelica.Blocks.Interfaces.RealInput spotPrice annotation (Placement(
        transformation(
        extent={{-20,-20},{20,20}},
        rotation=270,
