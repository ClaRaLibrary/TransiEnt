...
//________________________________________________________________________________//
  ...
  parameter Modelica.SIunits.VolumeFraction phi_H2max = simCenter.phi_H2max "Maximum admissible volume fraction of H2 in NGH2 at STP";
...
public
  ...
  TILMedia.VLEFluid_pT vleGasNG_STP(
    T=T_stp,
    p=p_stp,
