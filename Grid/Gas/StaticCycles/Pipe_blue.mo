...
//___________________________________________________________________________//
  ...
  final parameter Real zeta_tot = if quadraticPressureLoss then Delta_p_nom/m_flow_nom^2 else Delta_p_nom/m_flow_nom "Linear/quadratic pressure loss coefficient";
