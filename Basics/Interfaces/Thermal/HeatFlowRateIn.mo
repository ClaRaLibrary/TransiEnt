...
<p>Extends the MSL RealInput Connector by defining the quantity, unit and display unit. This connector should only be used for global horizontal radiation (type consistency).</p>
