...
connector SpecificEnthalpyIn=Modelica.Blocks.Interfaces.RealInput(final quantity="SpecificEnthalpy", final unit="J/kg", displayUnit="J/kg")
  "Specific enthalpy input in J/kg"
