...
connector TemperatureCelsiusOut "Temperature output in degree Celsius"
...
//________________________________________________________________________________//
  ...
  extends Modelica.Blocks.Interfaces.RealOutput(final quantity= "Temp_C", final unit="degC", displayUnit="degC");
