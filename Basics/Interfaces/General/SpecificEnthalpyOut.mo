...
connector SpecificEnthalpyOut "Specific enthalpy output in J/kg"
...
//________________________________________________________________________________//
  ...
  // _____________________________________________
   ...
   extends Modelica.Blocks.Interfaces.RealOutput(final quantity="SpecificEnthalpy", final unit="J/kg", displayUnit="J/kg");
