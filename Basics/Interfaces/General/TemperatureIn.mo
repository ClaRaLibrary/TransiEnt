...
connector TemperatureIn "Temperature input in Kelvin"
...
//________________________________________________________________________________//
  ...
  // _____________________________________________
   ...
   extends Modelica.Blocks.Interfaces.RealInput(final quantity="Temperature", final unit="K", displayUnit="degC");
