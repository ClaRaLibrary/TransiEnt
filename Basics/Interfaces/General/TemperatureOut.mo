...
connector TemperatureOut "Temperature output in Kelvin"
...
//________________________________________________________________________________//
  ...
  // _____________________________________________
   ...
   extends Modelica.Blocks.Interfaces.RealOutput(final quantity="Temperature", final unit="K", displayUnit="degC");
