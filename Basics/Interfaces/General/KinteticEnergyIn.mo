...
connector KinteticEnergyIn "Input for kinetic energy in J"
...
extends Modelica.Blocks.Interfaces.RealInput(final quantity= "KineticEnergy", final unit="J", displayUnit="J");
