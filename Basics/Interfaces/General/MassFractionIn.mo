...
connector MassFractionIn "Mass Fraction input in kg/kg"
...
//________________________________________________________________________________//
  ...
  // _____________________________________________
   ...
   extends Modelica.Blocks.Interfaces.RealInput(final quantity="MassFraction", final unit="kg/kg", displayUnit="kg/kg");
