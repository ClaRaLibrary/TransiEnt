...
connector MoleFractionOut=Modelica.Blocks.Interfaces.RealOutput(final quantity="MoleFraction", final unit="mol/mol", displayUnit="mol/mol")
  "Mole Fraction output in mol/mol"
