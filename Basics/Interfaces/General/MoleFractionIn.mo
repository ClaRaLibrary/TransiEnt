...
connector MoleFractionIn=Modelica.Blocks.Interfaces.RealInput(final quantity="MoleFraction", final unit="mol/mol", displayUnit="mol/mol")
  "Mole Fraction input in mol/mol"
