...
connector PressureOut "Pressure output in Pa"
...
//________________________________________________________________________________//
  ...
  // _____________________________________________
   ...
   extends Modelica.Blocks.Interfaces.RealOutput(final quantity="Pressure", final unit="Pa", displayUnit="bar");
...
<p>Modelica RealOutput: pressure in [Pa]</p>
