...
connector KineticEnergyOut=Modelica.Blocks.Interfaces.RealOutput(final quantity= "KineticEnergy", final unit="J", displayUnit="J")
  "Output for kinetic energy in J"
