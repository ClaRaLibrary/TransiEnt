...
connector MassFractionOut=Modelica.Blocks.Interfaces.RealOutput(final quantity="MassFraction", final unit="kg/kg", displayUnit="kg/kg")
  "Mass Fraction output in kg/kg"
