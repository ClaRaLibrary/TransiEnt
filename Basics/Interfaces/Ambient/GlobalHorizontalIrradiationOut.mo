...
connector GlobalHorizontalIrradiationOut "Solar irradiation on a surface perpendicular to the suns rays"
...
//___________________________________________________________________________//
  ...
  extends Modelica.Blocks.Interfaces.RealOutput(final quantity= "GlobalHorizontalIrradiation", final unit="W/m2", displayUnit="W/m2");
...
end GlobalHorizontalIrradiationOut;
