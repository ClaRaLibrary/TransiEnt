...
//________________________________________________________________________________//
  ...
  TransiEnt.Basics.Interfaces.Gas.RealGasPortIn gasPortIn(Medium=medium_sg6) annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
  TransiEnt.Basics.Interfaces.Gas.RealGasPortOut gasPortOut(Medium=medium_ng7_sg_o2) annotation (Placement(transformation(extent={{90,-10},{110,10}})));
