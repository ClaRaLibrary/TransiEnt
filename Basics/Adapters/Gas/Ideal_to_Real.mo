...
//________________________________________________________________________________//
  ...
  TransiEnt.Basics.Interfaces.Gas.IdealGasEnthPortIn gasPortIn(Medium=ideal) annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
  TransiEnt.Basics.Interfaces.Gas.RealGasPortOut gasPortOut(Medium=real) annotation (Placement(transformation(extent={{90,-10},{110,10}})));
