...
model RealSG4_var_to_RealNG7_H2_var "Adapter that switches from real NG4_SG to real NG7_SG fluid models"
...
//________________________________________________________________________________//
  ...
  //             Visible Parameters
  // _____________________________________________
  replaceable parameter TransiEnt.Basics.Media.Gases.VLE_VDIWA_SG4_var medium_sg4_var constrainedby TILMedia.VLEFluidTypes.BaseVLEFluid "SG4_var fluid model" annotation(Dialog(group="Fundamental Definitions"), choicesAllMatching);
  replaceable parameter TransiEnt.Basics.Media.Gases.VLE_VDIWA_NG7_H2_var medium_ng7_H2_var constrainedby TILMedia.VLEFluidTypes.BaseVLEFluid "NG7 SG fluid model" annotation (Dialog(group="Fundamental Definitions"), choicesAllMatching);
  ...
  TransiEnt.Basics.Interfaces.Gas.RealGasPortIn gasPortIn(Medium=medium_sg4_var) annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
  TransiEnt.Basics.Interfaces.Gas.RealGasPortOut gasPortOut(Medium=medium_ng7_H2_var) annotation (Placement(transformation(extent={{90,-10},{110,10}})));
...
equation
  ...
  gasPortIn.xi_outflow=ones(medium_sg4_var.nc-1);
...
end RealSG4_var_to_RealNG7_H2_var;
