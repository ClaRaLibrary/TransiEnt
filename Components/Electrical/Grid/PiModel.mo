...
<p><span style=\"font-family: MS Shell Dlg 2;\">LoD 3 - multiple phase, active and reactive power, voltage and frequency.</span></p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Model created by Patrick G&ouml;ttsch and revised by Pascal Dubucq (dubucq@tuhh.de) on 01.10.2014</span></p>
</html>"));
end PiModel;
