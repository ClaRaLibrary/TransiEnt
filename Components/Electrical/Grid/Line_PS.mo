...
<p><span style=\"font-family: MS Shell Dlg 2;\">Simple line model using Transient electrical interfaces with LoD 1 (only active power and frequency) and constant power loss specified in percent.</span></p>
