...
//___________________________________________________________________________//
  ...
  //                  Interfaces
  // _____________________________________________
  TransiEnt.Basics.Interfaces.Electrical.ActivePowerPort epp annotation (Placement(transformation(extent={{90,-10},{110,10}}), iconTransformation(extent={{94,-8},{108,6}})));
...
<p><span style=\"font-family: MS Shell Dlg 2;\"> LoD 1 - only power flow and frequency</span></p>
