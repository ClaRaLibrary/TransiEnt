...
equation
  ...
  annotation (defaultComponentName="IdealTriac",Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}})),
...
<p><span style=\"font-family: MS Shell Dlg 2;\">LoD 1 - active power and frequency only</span></p>
