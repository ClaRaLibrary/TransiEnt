...
//___________________________________________________________________________//
  ...
  parameter Modelica.SIunits.PressureDifference Delta_p_set = 1.2e5 "Set pressure at worst hydraulc point";

  parameter TILMedia.VLEFluidTypes.BaseVLEFluid Medium = simCenter.fluid1 "Medium in the component";

  parameter Real k=5 "Gain for PI-Controller" annotation(Dialog(group="PI-Controller"));
  parameter Modelica.SIunits.Time Tc=1 "Time constant for PI-Controller" annotation(Dialog(group="PI-Controller"));
