...
//copied from ClaRa.Components.TurboMachines.Pumps.Pump_Base
...
protected
  ClaRa.Basics.Interfaces.EyeIn eye_int annotation (Placement(transformation(extent={{45,-61},{47,-59}})));
