...
model HydrogenSphericalPressureVessel_high "Cost model for hydrogen spherical pressure vessels (300...3000m3 geo, 20 bar)"
...
//Table 27.9, page 676: p_max = 2 MPa
  extends PartialCostSpecs(
    ...
    C_inv_size=583.1*size1+186892 "Curve fitting for table data with pmax=20bar",
    factor_OM=0.02 "2%, Stolzenburg 2014, small hydrogen storage",
    lifeTime=30 "Stolzenburg 2014, small hydrogen storage");
end HydrogenSphericalPressureVessel_high;
