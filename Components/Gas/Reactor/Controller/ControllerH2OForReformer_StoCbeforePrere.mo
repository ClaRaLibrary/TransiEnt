...
equation
  ...
  n_flow_C_beforePrere =max(eps, m_flow_feed*(massComposition[1]/M_CH4 + 2*massComposition[2]/M_C2H6 + 3*massComposition[3]/M_C3H8 + 4*massComposition[4]/M_C4H10));
  n_flow_H2O_beforePrere =(m_flow_feed*massComposition[7] + m_flow_H2OforReformerCalc)/M_H2O;
...
<p>Model created by Carsten Bode (c.bode@tuhh.de) on Fri Jul 04 2017<br> </p>
</html>"));
