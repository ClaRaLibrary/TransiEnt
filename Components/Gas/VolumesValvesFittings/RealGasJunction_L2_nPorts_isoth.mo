...
//________________________________________________________________________________//
  ...
  TransiEnt.Components.Gas.VolumesValvesFittings.RealGasJunction_L2_nPorts junction(
  ...
  Modelica.Thermal.HeatTransfer.Sources.PrescribedTemperature prescribedTemperature annotation (Placement(transformation(extent={{-30,50},{-10,70}})));
...
equation
  connect(realExpression.y, prescribedTemperature.T) annotation (Line(points={{-41,60},{-32,60}}, color={0,0,127}));
  connect(prescribedTemperature.port, junction.heat) annotation (Line(points={{-10,60},{0,60},{0,33}},color={191,0,0}));
