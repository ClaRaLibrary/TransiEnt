...
//___________________________________________________________________________//
  ...
  replaceable TransiEnt.Components.Boundaries.Heat.Heatflow_L1 heatBoundary(use_Q_flow_in=false) constrainedby TransiEnt.Components.Boundaries.Heat.Base.PartialHeatBoundary annotation (choicesAllMatching=true, Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={2,0})));
