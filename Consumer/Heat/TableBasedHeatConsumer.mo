...
equation
  ...
  collectHeatingPower.heatFlowCollector.Q_flow = -Q_flow_dem;
  connect(collectHeatingPower.heatFlowCollector, modelStatistics.heatFlowCollector[collectHeatingPower.typeOfResource]);
