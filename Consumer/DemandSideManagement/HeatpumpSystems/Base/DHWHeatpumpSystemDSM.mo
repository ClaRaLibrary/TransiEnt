...
model DHWHeatpumpSystemDSM "Domestic hot water production by monovalent heat pump system"
...
//___________________________________________________________________________//
  extends TransiEnt.Consumer.DemandSideManagement.HeatpumpSystems.Base.PartialHeatPumpSystemDSM(final nStor=1, final E_stor={storageDHW.C*params.DTdb_heatpump});
...
equation
  ...
  connect(T_stor_dhw_set.y, Heatpump.u_set) annotation (Line(points={{-53,16},{-38.4,16}},            color={0,0,127}));
