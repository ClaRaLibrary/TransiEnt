...
algorithm
 for i in 1:size(A,1) loop
  ...
  success:=DymolaCommands.SimulatorAPI.simulateModel(simulationCall, stopTime=tend,outputInterval=dt, tolerance=1e-005, resultFile=resultFileName + "_"+String(i)+".mat");
