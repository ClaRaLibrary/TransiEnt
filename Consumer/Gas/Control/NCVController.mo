...
//___________________________________________________________________________//
  ...
  Modelica.Blocks.Interfaces.RealInput m_flow_is "Current hydrogen mass flow in kg/s"
        ...
        rotation=90,
        origin={40,106})));
  Modelica.Blocks.Interfaces.RealInput NCV_is "actual net calorific value in J/kg"   annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={-40,104})));
...
<p>Model to controll mass flow rate by measured net calorific value and given enthalpy flow rate input.</p>
